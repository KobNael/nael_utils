...
.. command:: run_coverage
  ...
  The reports are created in ``${data_base_path}/coverage-reports``.
  ...
  ``${data_base_path}/coverage-reports/gcovr``, with main file ``index.html``.

  For lcov, report is named ``lcov.info``.
  A HTML report is also generated in
  ``${data_base_path}/coverage-reports/lcov``, with main file ``index.html``.
...
### Automation
### ===============================================================================================
if(NOT DEFINED data_base_path)
    set (data_base_path ${CMAKE_BINARY_DIR})
endif()
