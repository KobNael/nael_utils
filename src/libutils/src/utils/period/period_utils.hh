...
std::list<PeriodT> getUnion(std::list<PeriodT> const &periods1, std::list<PeriodU> const &periods2, bool merge_adjacent=true);
/**
 ...
 */
template<typename PeriodT, typename PeriodU>
std::list<PeriodT> getUnion(PeriodT const &period, std::list<PeriodU> const& periods, bool merge_adjacent=true)
{
    return getUnion(std::list<PeriodT>(1,period), periods, merge_adjacent);
}
 ...
 */
template<typename PeriodT, typename PeriodU>
std::list<PeriodT> getUnion(std::list<PeriodT> const &periods, PeriodU const &period, bool merge_adjacent=true)
{
    return getUnion(periods, std::list<PeriodU>(1,period), merge_adjacent);
}
/**
 ...
 */
template<typename PeriodT, typename PeriodU>
std::list<PeriodT> getUnion(PeriodT const &period1, PeriodU const& period2, bool merge_adjacent=true)
{
    return getUnion(std::list<PeriodT>(1,period1), std::list<PeriodU>(1, period2), merge_adjacent);
}
 ...
 */
template<typename PeriodT, typename PeriodU>
std::list<PeriodT> getInter(std::list<PeriodT> const &periods1, std::list<PeriodU> const &periods2, bool merge_adjacent=true);
/**
 ...
 */
template<typename PeriodT, typename PeriodU>
std::list<PeriodT> getInter(PeriodT const &period, std::list<PeriodU> const& periods, bool merge_adjacent=true)
{
    return getInter(std::list<PeriodT>(1,period), periods, merge_adjacent);
}
/**
 ...
 */
template<typename PeriodT, typename PeriodU>
std::list<PeriodT> getInter(std::list<PeriodT> const &periods, PeriodU const &period, bool merge_adjacent=true)
{
    return getInter(periods, std::list<PeriodU>(1,period), merge_adjacent);
}
/**
 ...
 */
template<typename PeriodT, typename PeriodU>
std::list<PeriodT> getInter(PeriodT const &period1, PeriodU const& period2, bool merge_adjacent=true)
{
    return getInter(std::list<PeriodT>(1,period1), std::list<PeriodU>(1, period2), merge_adjacent);
}
 ...
 */
template<typename PeriodT, typename PeriodU>
std::list<PeriodT> getDiff(std::list<PeriodT> const &periods1, std::list<PeriodU> const &periods2, bool merge_adjacent=true);
/**
 ...
 */
template<typename PeriodT, typename PeriodU>
std::list<PeriodT> getDiff(PeriodT const &period, std::list<PeriodU> const& periods, bool merge_adjacent=true)
{
    return getDiff(std::list<PeriodU>(1,period), periods, merge_adjacent);
}
/**
 ...
 */
template<typename PeriodT, typename PeriodU>
std::list<PeriodT> getDiff(std::list<PeriodT> const &periods, PeriodU const &period, bool merge_adjacent=true)
{
    return getDiff(periods, std::list<PeriodU>(1,period), merge_adjacent);
}
/**
 ...
 */
template<typename PeriodT, typename PeriodU>
std::list<PeriodT> getDiff(PeriodT const &period1, PeriodU const& period2, bool merge_adjacent=true)
{
    return getDiff(std::list<PeriodT>(1,period1), std::list<PeriodU>(1, period2), merge_adjacent);
}
